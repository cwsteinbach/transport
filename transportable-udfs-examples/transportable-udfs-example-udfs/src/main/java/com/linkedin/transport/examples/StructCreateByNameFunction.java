...
public class StructCreateByNameFunction extends StdUDF4<StdString, StdData, StdString, StdData, StdStruct>
  ...
  public List<String> getInputParameterSignatures() {
    return ImmutableList.of("varchar", "K", "varchar", "V");
  }
  ...
  public StdStruct eval(StdString field1Name, StdData field1Value, StdString field2Name, StdData field2Value) {
    StdStruct struct = getStdFactory().createStruct(ImmutableList.of(field1Name.get(), field2Name.get()),
