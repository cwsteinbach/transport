...
public class Constants {
  ...
  public static final String INTERFACE_NOT_IMPLEMENTED_ERROR =
      String.format("A Transport UDF should implement %s interface.", TopLevelStdUDF.class.getSimpleName());

  public static final String MORE_THAN_ONE_TYPE_OVERRIDING_ERROR =
      String.format("%s methods should be overriden in only one class/interface in the type hierarchy.",
