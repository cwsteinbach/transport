...
public class AssertHiveGenericUdf {
  ...
  public static void assertFunction(GenericUDF udf, ObjectInspector[] objectInspectors, Object[] arguments,
    ...
    GenericUDF.DeferredObject[] deferredObjects = Arrays.stream(arguments)
        .map(object -> new GenericUDF.DeferredJavaObject(object)).toArray(GenericUDF.DeferredObject[]::new);
    try {
